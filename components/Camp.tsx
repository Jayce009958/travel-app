...
const CapmSite = ({ backgroundImage, title, subtitle, peopleJoined }: CampProps) => {
  return (
...
const Camp = () => {
  return (
    <section className='2xl:max-container relative flex flex-col py-10 lg:mb-10 lg:py-20 xlg:mb-20'>
      <div className='hide-scrollbar flex h-[340px] w-full items-start justify-start gap-8 overflow-x-auto lg:h-[400px] xl:h-[640px]'>
        ...
        <CapmSite 
          ...
          subtitle="Somewhere in the Wilds"
          peopleJoined="50+ Joined"
        />
      </div>
